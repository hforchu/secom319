...
function App() {
  ...
  return (
    ...
    <h3>About Us</h3>
    <p>Franck Biyogue Bi Ndoutoume: Sophomore in Software Enginnering: franck@iastate.edu</p>
    <p>Harvey Forchu: Senior in Computer Engineering: hforchu@iastate.edu</p>
    <p>COMS 319 By Abraham Netzahualcoy Aldaco Gastelum. </p>
    <p>Our project is a Catalog of Products.</p>
    <p>Spring 2023 Group 9</p>
  </div>
